...
function saveEmoji(event){	//Emoji name 매개변수로 받아와야함
	...
	var text_color;
	saveInfo[index].name = ""; 	// 이모티콘 name 어떻게 해야하지 ?
...
var saveInfo = 
	[
		{
			projectName : "",  //공통적이니까 없애고 아예 프로젝트 name으로 파일을 저장해도 될듯?
...
var count = 0;
var index = 0;
var location_check10 = "상";
var location_check30 = "우";		//기본으로 추가하고 안 움직였을 때 위치